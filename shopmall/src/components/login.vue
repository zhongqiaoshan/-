<template>
  <div id="center" class="page">
    <div class="avatar asd" v-if="userInfo">
      <div class="avator-icon img-go">
        <img :src="userInfo.avatar" alt="" >
        <input type="file" class="zxc" @change="handleUpdAvatar" >
      </div>
      <div class="nick-name img-gos">{{ this.$store.state.user.userInfo.nickname }}</div>
    </div>

    <div class="center-view" v-else>
      <div class="avatar">
        <img
          src="../assets/avatar.png"
          class="avator-icon"/>
        <router-link tag="div" to="/register" class="nick-name">立即登录</router-link>
    </div>
    </div>
    ...
    <ul class="my-order-tab">
      ...
      <li data-enter-time="1561988002" data-click-fun="track_f_413856">
        <img
    ...
    <!---->
    <div class="margin-set my-card" data-enter-time="1561988002" data-click-fun="track_f_137130">
      <img
    ...
    <div class="margin-set my-card" data-enter-time="1561988002" data-click-fun="track_f_202102">
      <img
    ...
    <div class="margin-set my-balance" data-enter-time="1561988002" data-click-fun="track_f_961535">
      <img
    ...
    <div class="margin-set system-set" data-enter-time="1561988002" data-click-fun="track_f_960295">
      <img
        ...
        alt
      />
      <span class="label" v-on:click="handleLogout">退出</span>
      <img
        src="data:image/png;base64,"
        alt
        class="arrow"
